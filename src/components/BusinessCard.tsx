...
export default function BusinessCard() {
  ...
  return (
    <div
      ref={cardRef}
      className="absolute bottom-[3%] md:bottom-[7%] left-1/2 -translate-x-1/2 w-full max-w-md pt-16 md:pt-30 pointer-events-auto h-fit max-h-[calc(100vh-40px)] md:max-h-[calc(100vh-100px)] flex flex-col"
    >
      {/* Pitched Roof with Pixel-Art Shingles */}
      <div
        id="house-roof"
        className="absolute left-0 right-0 top-0 h-16 md:h-30 z-20 shrink-0"
      >
        <svg
          viewBox="0 0 400 120"
      ...
      <div
        id="house-body"
        className={cn(
          "relative z-10 bg-warm-cream border-x-4 border-b-4 border-charcoal rounded-b-[40px] p-3 md:p-6 pb-20 md:pb-36 shadow-2xl flex flex-col items-center text-center space-y-2 md:space-y-3 pt-4 md:pt-8 flex-1 min-h-0 overflow-hidden",
          "before:absolute before:inset-0 before:bg-amber-50/40 before:rounded-b-[36px] before:pointer-events-none",
        )}
      >
        {/* Window (Avatar) */}
        <div id="house-window" className="relative mb-0.5 md:mb-1 shrink-0">
          {/* Pixel-art circular window frame */}
          <div className="relative w-16 h-16 md:w-24 md:h-24 group transition-transform hover:scale-105">
        ...
        {/* Content */}
        <div className="space-y-0.5 md:space-y-1 mt-0.5 md:mt-2 shrink-0">
          <h1 className="text-[10px] md:text-sm leading-tight tracking-tight text-charcoal">
            Sinem Demiröz Gezici
          </h1>
          <a
            href="mailto:sinem@gezici.me"
            className="text-[8px] md:text-[10px] text-muted hover:text-coral transition-colors block"
          >
            sinem@gezici.me
          </a>
        </div>
        ...
        <div className="w-full h-px bg-charcoal/10 shrink-0 my-0.5 md:my-0" />

        <div className="w-full text-left space-y-0.5 md:space-y-2 flex-1 min-h-0 flex flex-col overflow-hidden">
          <h2 className="text-[6px] md:text-[8px] uppercase tracking-[0.15em] text-muted shrink-0">
            Experience
          </h2>
          <div className="flex-1 min-h-0 overflow-y-auto pr-1 md:pr-2 mb-2 md:mb-6 scrollbar-thin">
            <ExperienceList />
          </div>
        </div>
      </div>
      ...
      <div
        className="absolute bottom-0 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center cursor-pointer group scale-[0.65] md:scale-100 origin-bottom"
